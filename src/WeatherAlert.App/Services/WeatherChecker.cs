...
namespace WeatherAlert.App.Services;
...
public sealed class WeatherChecker : IWeatherChecker
{
    ...
    {
        var cityFromState = await _appStateRepository.GetValueAsync("current_city_code", cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var body = $"{summary.Date:yyyy-MM-dd} {periodText} 强度 {summary.IntensityLabel}";
